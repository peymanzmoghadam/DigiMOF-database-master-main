...
STOPLIST = {
     'salts','Tables','numbers', 'copper(II)','l-proline','HCl','fluorite', 'dicarboxylate', 'triazole', 'gold', 'lead', 'yellow', 'epidermal growth factor', 'pristine', 'transdermal patch', 'olive oil', 'groundnut oil',
